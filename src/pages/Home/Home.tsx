    ...
    <div className="container mx-auto relative px-4">
      <div className="flex items-center justify-between py-6">
        ...
        <div className="flex items-center mb-4 md:block">
          <a className="mr-8 font-semibold hover:text-white" href="#">
            Documentation
          </a>
          <a className="bg-indigo-600 btn hover:bg-indigo-500" href="#">
            Sign up
          </a>
        </div>
      </div>
      ...
      <div className="mb-16 border-b border-gray-800">
        ...
        <div className="flex flex-col mb-8 sm:flex-row">
          <div className="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last">
            <img className="rounded-sm" src={features} alt="" />
          </div>
        ...
        <div className="flex flex-col mb-8 sm:flex-row">
          <div className="flex items-center mb-8 sm:w-1/2 md:w-5/12">
            <img className="rounded-sm" src={features2} alt="" />
          </div>
        ...
        <div className="flex flex-col mb-8 sm:flex-row">
          <div className="flex items-center mb-8 sm:w-1/2 md:w-5/12 sm:order-last">
            <img className="rounded-sm" src={features3} alt="" />
          </div>
          <div className="flex flex-col justify-center mb-8 sm:w-1/2 md:w-7/12 sm:pr-16">
            <p className="mb-2 text-sm font-semibold leading-none text-center text-indigo-600 uppercase sm:text-left">
              Lightning fast workflow
      ...
      >
        <h2 className="max-w-xs mx-auto mb-10 text-2xl font-bold text-center text-white sm:text-3xl sm:mr-10 sm:max-w-full sm:text-left sm:w-1/3 sm:mx-0 sm:mb-0 md:w-1/2 lg:w-7/12">
      ...
      <div className="flex flex-col justify-between mb-8 text-center sm:flex-row">
        <p className="order-last mb-4 text-sm text-gray-500 sm:order-first">
          Designed by
          <a href="https://cruip.com/" className="text-white">
            Cruip
          </a>
          . Coded by
          <a href="https://michelegera.dev/" className="text-white">
            michelegera
          </a>
        </p>
